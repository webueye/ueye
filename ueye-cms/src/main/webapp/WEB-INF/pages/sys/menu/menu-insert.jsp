					...
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr class="th" id="texp" style="display:table-row">
								...
								<td class="ltd">
				                   	<input class="input-small required" name="roleType" value="true" type="radio" />工厂
									<input class="input-small required" name="roleType" value="false" type="radio" style="margin-left: 20px;"/>经销商
